...
namespace Cainos.InteractivePixelWater
{
    ...
    public class PixelWater : MonoBehaviour
    {
        ...
        [Space]
        [FoldoutGroup("FX")] public AudioClip bigSplashSound;
        ...
        public void AddSplash ( Vector3 pos, float size, float speed)
        {
            ...
            //play sound
            if (speed > 6.0f && AudioManager.Instance != null && bigSplashSound != null)
            {
                AudioManager.Instance.PlaySFXRandomPitch(bigSplashSound, 0.1f, 0.85f, 1.15f);
            }
